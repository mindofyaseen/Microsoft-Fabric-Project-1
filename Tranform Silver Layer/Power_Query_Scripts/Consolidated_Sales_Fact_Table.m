let
  ...
  #"Navigation 5" = #"Navigation 4"{[Name = "AdventureWorks_Sales_2016.cvsv"]}[Content],
  #"Imported CSV" = Csv.Document(#"Navigation 5", [Delimiter = ",", Columns = 8, QuoteStyle = QuoteStyle.None]),
